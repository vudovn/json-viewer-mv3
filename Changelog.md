# 0.19.0 - 2025-11-20 (Manifest V3 Migration + UI Redesign)

**BREAKING CHANGES:**
* Migrated to Manifest V3
* Minimum Chrome version: 88+
* Combined background scripts into single service worker
* Updated Chrome APIs: `chrome.extension.getURL()` → `chrome.runtime.getURL()`

**UI Improvements:**
* ✨ Complete UI redesign with modern CSS (Tailwind-inspired)
* 🎨 Modern card-based layout với gradient colors
* 💫 Smooth transitions và hover effects
* 📖 Collapsible documentation panels
* 🎯 Better UX với emoji icons
* 🇻🇳 Vietnamese language support
* 🔒 CSP-compliant (no external CDN dependencies)

**Technical Changes:**
* Created new `background.js` service worker (combines old backend.js + omnibox.js)
* Updated manifest format for web_accessible_resources
* Moved permissions to host_permissions
* Updated webpack configuration
* Fixed localStorage issues in service worker (using chrome.storage API)
* Modernized build system (node-sass → sass)
